...
import componentes_swing.PanelColor;
import postgre_db.PostgreDB;

public class ModificarLinea extends JPanel {

	public ModificarLinea(GestionarLineas panelGestionar, Integer id, String nombre, Color color) {
		...
		CampoJ cColorR = new CampoJ(String.valueOf(color.getRed()));
		EtiquetaJ eColorR = new EtiquetaJ("R");
		CampoJ cColorG = new CampoJ(String.valueOf(color.getGreen()));
		EtiquetaJ eColorG = new EtiquetaJ("G");
		CampoJ cColorB = new CampoJ(String.valueOf(color.getBlue()));
		...
		cons.insets = new Insets(10,10,10,10);
		vistaColor.actualizarColor(color.getRed(), color.getGreen(), color.getBlue());
				...
				aceptar.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						if(camposCompletos()) {
							...
							PostgreDB.modificarLinea(id, nom, col);
